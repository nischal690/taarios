...
import 'nav_bar_with_middle_button_copy_copy_model.dart';
export 'nav_bar_with_middle_button_copy_copy_model.dart';

class NavBarWithMiddleButtonCopyCopyWidget extends StatefulWidget {
  const NavBarWithMiddleButtonCopyCopyWidget({super.key});

  @override
  State<NavBarWithMiddleButtonCopyCopyWidget> createState() =>
      _NavBarWithMiddleButtonCopyCopyWidgetState();
}

class _NavBarWithMiddleButtonCopyCopyWidgetState
    extends State<NavBarWithMiddleButtonCopyCopyWidget> {
  late NavBarWithMiddleButtonCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavBarWithMiddleButtonCopyCopyModel());
